        ...
        for field in form["feedback_questions"]:
            ...
            if is_anon:
                new_feedback = feedback(
                    j, field.question_id, id, 0, message, feedback_time, 1, 1, 1)
            elif "user_id" in session:
                new_feedback = feedback(
                    j, field.question_id, id, session["user_id"], message, feedback_time, 1, 1, 0)
            else:
                new_feedback = feedback(
                    j, field.question_id, id, 0, message, feedback_time, 1, 1, 0)
